        ...
        <div class="auth-modal bg-white rounded-2xl max-w-md w-full overflow-hidden relative">
            <div class="auth-modal-header p-6 text-center relative">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button id="closeResetPasswordModal" class="modalClose_BT close-btn focus:outline-none">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <p class="text-purple-100 text-sm">Crie uma nova senha segura</p>
            </div>
            ...
            <div class="p-6">
                <form id="resetPasswordForm" class="space-y-5">
                    <div class="input-group relative">
                        ...
                        <input type="password" id="new-password" name="password" class="input-gradient pr-12" placeholder="Digite sua nova senha" required>
                        <button type="button" class="passwordToggle_BT" onclick="togglePassword('new-password', this)">
                    ...
                    <div class="input-group relative">
                        ...
                        <input type="password" id="confirm-new-password" name="confirm-password" class="input-gradient pr-12" placeholder="Confirme sua nova senha" required>
                        <button type="button" class="passwordToggle_BT" onclick="togglePassword('confirm-new-password', this)">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
