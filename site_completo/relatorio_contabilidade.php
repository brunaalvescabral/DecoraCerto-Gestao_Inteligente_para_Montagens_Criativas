...
<head>
    <meta charset="UTF-8" />
    <title>Relatório de Contabilidade</title>
    <style>
...
<div class="container">
    ...
    <h2>Relatório de Contabilidade</h2>
    ...
    <div class="export-links">
        <a href="exportar_contabilidade_pdf.php?inicio=<?= urlencode($data_inicio) ?>&fim=<?= urlencode($data_fim) ?>">Exportar PDF</a>
        <a href="exportar_contabilidade_excel.php?inicio=<?= urlencode($data_inicio) ?>&fim=<?= urlencode($data_fim) ?>">Exportar Excel</a>
    </div>
</div>
</body>
</html>