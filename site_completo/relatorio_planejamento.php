    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" style="text-align:center; color:#999;">Nenhum registro encontrado para o período selecionado.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
        ...
        <div class="export-links">
            <a href="exportar_planejamento_pdf.php?inicio=<?= urlencode($data_inicio) ?>&fim=<?= urlencode($data_fim) ?>">Exportar PDF</a>
            <a href="exportar_planejamento_excel.php?inicio=<?= urlencode($data_inicio) ?>&fim=<?= urlencode($data_fim) ?>">Exportar Excel</a>
        </div>
    </div>
</body>
</html>
