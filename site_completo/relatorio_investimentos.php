...
$query = "
    ...
    WHERE data_investimento BETWEEN '$data_inicio' AND '$data_fim'
";
...
<div class="container">
    ...
    <div class="export-links">
        <a href="exportar_investimentos_pdf.php?inicio=<?= urlencode($data_inicio) ?>&fim=<?= urlencode($data_fim) ?>">Exportar PDF</a>
        <a href="exportar_investimentos_excel.php?inicio=<?= urlencode($data_inicio) ?>&fim=<?= urlencode($data_fim) ?>">Exportar Excel</a>
    </div>
</div>
</body>
</html>
